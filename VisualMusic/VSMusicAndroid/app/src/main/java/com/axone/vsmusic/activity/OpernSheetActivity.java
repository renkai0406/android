...
import com.axone.vsmusic.opern.HelpActivity;
import com.axone.vsmusic.opern.MidiFile;
import com.axone.vsmusic.opern.MidiFileException;
import com.axone.vsmusic.opern.MidiOptions;
import com.axone.vsmusic.opern.MidiPlayer;
import com.axone.vsmusic.opern.Piano;
import com.axone.vsmusic.opern.SettingsActivity;
import com.axone.vsmusic.opern.SheetMusic;
 ...
 *
 */
public class OpernSheetActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.opern_sheet_menu, menu);
        return true;
    }
    ...
    private void showSaveImagesDialog() {
         ...
         final View dialogView= inflator.inflate(R.layout.opern_saveimages_dialog, null);
