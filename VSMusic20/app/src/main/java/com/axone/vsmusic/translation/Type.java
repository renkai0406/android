...
public interface Type {
    ...
    public static final int UPDATE_USER_INFO_NAME = 22;
    public static final int UPDATE_USER_INFO_OTHER = 24;
    public static final int GET_USER_INFO_NAME = 23;
    public static final int GET_USER_INFO_OTHER = 25;
    ...
    //其他常量定义
    public static int BLOOD_A = 1;
    public static int BLOOD_B = 2;
    public static int BLOOD_AB = 3;
    public static int BLOOD_O = 4;
    public static int BLOOD_OTHER = 0;

    public static int SEX_MAN = 0;
    public static int SEX_WOMAN = 1;
    public static int SEX_SECRECY = 2;
