...
public class MidiPlayer extends LinearLayout {
    ...
    public MidiPlayer(Activity activity) {
        ...
        setBackgroundColor(Color.parseColor("#66BE94"));
    }
    ...
    void CreateButtons() {
        ...
        rewindButton.setBackgroundColor(Color.parseColor("#66BE94"));
        ...
        stopButton.setBackgroundColor(Color.parseColor("#66BE94"));
        ...
        playButton.setBackgroundColor(Color.parseColor("#66BE94"));
        ...
        fastFwdButton.setBackgroundColor(Color.parseColor("#66BE94"));
        ...
        speedBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            public void onProgressChanged(SeekBar bar, int progress, boolean fromUser) {
                speedText.setText("   速度: " + String.format(Locale.US, "%03d", progress) + "%   ");
            }
        ...
        settingsButton.setBackgroundColor(Color.parseColor("#66BE94"));
